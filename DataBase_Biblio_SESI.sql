...
('360K222E2022', 'O Homem Invisível', 'Wells, H. G.', 7, 360, 1, 'A narrativa de um cientista que descobre o segredo da invisibilidade e as consequências de sua descoberta. O livro é uma reflexão sobre poder e moralidade.', '031.340D404F2015.Fundacao - Isaac Asimov.png', (SELECT CD_Unidade FROM Table_Unidade ORDER BY RAND() LIMIT 1)),
