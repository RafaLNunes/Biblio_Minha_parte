...
namespace Minha_Parte_Biblio
{
    public partial class FrmUserAnalitc : Form
    {
        ...
        ClUserModelo Model_User_ADM = new ClUserModelo();
        ...
        public FrmUserAnalitc(ClUserModelo user, ClInnerADMsModelo admuserview)
        {
            this.Model_User_ADM = user;
            this.Model_Inner_ADM = admuserview;
            InitializeComponent();
        }
